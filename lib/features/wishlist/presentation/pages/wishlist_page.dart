...
class _WishlistView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        BlocListener<HomeSessionCubit, HomeSessionState>(
                ...
                Expanded(
                  child: BlocBuilder<WishlistCubit, WishlistState>(
                    builder: (context, wishlistState) {
                      ...
                      return BlocBuilder<
                        WishlistProductsCubit,
                        WishlistProductsState
                      >(
                        builder: (context, productsState) {
                          if (productsState.status ==
                                  WishlistProductsStatus.initial ||
                              productsState.status ==
                                  WishlistProductsStatus.loading) {
                            return const Center(
                          ...
                          if (productsState.status ==
                              WishlistProductsStatus.failure) {
                            return Center(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    AppButton(
                                      ...
                                      onPressed: () {
                                        context
                                            .read<WishlistProductsCubit>()
                                            .loadFor(wishlistState.productIds);
                                      },
                                    ),
                                  ],
                                ),
